        ...
        <AnimatedSection>
          <div className="container max-w-7xl mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-white/70 text-lg max-w-2xl mx-auto leading-relaxed">
              A passionate team of technology innovators and talent experts dedicated to
              transforming businesses through cutting-edge solutions and strategic hiring.
            </p>
          </div>
        </AnimatedSection>
      </section>
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <AnimatedSection direction="left">
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                We saw organizations struggling to adapt without the right expertise
                and support. That’s where we stepped in — as a trusted partner
                delivering both innovative IT solutions and precision-driven recruitment services.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-8">
                Today, we work with startups, growing companies, and enterprise organizations across
                industries, helping them achieve measurable results and sustainable growth.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-8">
                Our diverse team of engineers, designers, marketers, and HR specialists brings deep
                expertise and a shared commitment to excellence in every engagement.
              </p>
            ...
            <AnimatedSection delay={200}>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-sm">
                  To become a globally trusted partner in IT innovation and talent
                  excellence — where businesses solve their toughest challenges and
                  professionals discover meaningful opportunities.
                </p>
              </div>
            </AnimatedSection>
          </div>
