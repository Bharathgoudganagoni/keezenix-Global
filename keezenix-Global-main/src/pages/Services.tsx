...
const hrServices = [
  {
    ...
    desc: "We identify and attract top-tier professionals using advanced sourcing strategies and a strong global network.",
    features: ["Executive Search", "Technical Hiring", "Bulk / Volume Hiring", "Candidate Evaluation"],
    img: recruitmentImg,
  },
  {
    icon: Building2,
    title: "Staffing Solutions",
    desc: "Flexible staffing models that give your business the agility to scale quickly and efficiently.",
    features: ["Contract Staffing", "Permanent Hiring", "Dedicated Project Teams", "Managed Workforce Solutions"],
    img: recruitmentImg,
  },
  {
    icon: UserCheck,
    title: "Recruitment Support",
    desc: "End-to-end recruitment support services that streamline your hiring process and reduce time-to-hire.",
    features: ["Recruitment Process Outsourcing (RPO)", "HR Consulting", "Job Description Creation", "Interview Coordination"],
    img: recruitmentImg,
  },
];
